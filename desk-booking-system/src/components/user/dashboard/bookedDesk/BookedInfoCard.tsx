...
import { useDeleteBooking } from "../../../../hooks/userHooks/bookings/useDeletBooking";
...
import { useSendComment } from "../../../../hooks/userHooks/comments/useSendComment";
//types
...
//main component
const BookedInfoCard: React.FC<DeskBookedProps> = (props) => {
  ...
  return (
    <Card
      className={` relative flex w-full max-w-sm mt-1 mb-1 shadow-lg border-none "bg-gradient-to-b from-white via-gray-200 to-white`}
    >
